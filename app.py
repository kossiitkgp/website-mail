...
def reg_mail(name,form_email,project):
    sg = sendgrid.SendGridAPIClient(apikey=os.environ['SENDGRID_API_KEY'])
    from_email = Email(form_email)
    to_email = [Email('dibyadascool@gmail.com'),Email("Kharagpur Winter of Code 2017 <kwoc@kossiitkgp.in>")]  # os.environ['KWOC_EMAIL']
    ...
    from_email = Email("Kharagpur Winter of Code 2017 <kwoc@kossiitkgp.in>")
    to_email = Email(form_email)
